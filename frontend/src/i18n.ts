...
const zh = {
  ...
  settings: {
    ...
    providerSubUrlPlaceholder: "订阅地址（https://your.worker.dev/KEY）",
...
const en: typeof zh = {
  ...
  settings: {
    ...
    providerSubUrlPlaceholder: "Subscription URL (https://your.worker.dev/KEY)",
